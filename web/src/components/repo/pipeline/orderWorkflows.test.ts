...
// A skipped workflow serializes `children` as null or omits it (omitempty); model
// both so the fixtures exercise the guarded deref.
...
// Fixtures carry null/absent children, runtime shapes the declared type forbids.
